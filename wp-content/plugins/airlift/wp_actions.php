	...
	class ALWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				ALAccount::addAccount($this->settings, 'da430e4dbf4411260cc229c05b6ce976', 'badd93901173bfe9c5115f7e15311eb4');
		ALAccount::updateApiPublicKey($this->settings, 'da430e4dbf4411260cc229c05b6ce976');
			}
